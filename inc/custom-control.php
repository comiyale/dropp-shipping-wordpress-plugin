...
class Dropshipping_Store_Custom_Control extends WP_Customize_Control {
...
class Dropshipping_Store_Image_Radio_Control extends WP_Customize_Control {
    public function render_content() {
        ...
        <ul class="controls" id='dropshipping-store-img-container'>
            <?php
            foreach ($this->choices as $value => $label) :
                $class = ($this->value() == $value) ? 'dropshipping-store-radio-img-selected dropshipping-store-radio-img-img' : 'dropshipping-store-radio-img-img';
                ?>
